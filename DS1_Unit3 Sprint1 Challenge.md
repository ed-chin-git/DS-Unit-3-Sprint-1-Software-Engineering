...
## An important part of code reviews, besides checking readability, is looking for clear documentation that explains the use and purpose of each method or function.  Checking for clear descriptive naming conventions also helps. 
